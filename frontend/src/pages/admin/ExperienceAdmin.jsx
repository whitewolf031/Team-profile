...
const css = `
  ...
  .ex-input, .ex-textarea, .ex-select { background: #1a2235; border: 1px solid #1e2d45; color: #e2e8f0; padding: 10px 14px; border-radius: 8px; font-family: 'Syne', sans-serif; font-size: 0.9rem; transition: border-color 0.2s; width: 100%; }
...
const TYPE_LABELS = { full_time: "To'liq stavka", part_time: "Yarim stavka", freelance: "Freelance", internship: "Stajirovka" };
const TYPE_COLORS = { full_time: "ex-tag-blue", part_time: "ex-tag-yellow", freelance: "ex-tag-purple", internship: "ex-tag-green" };

const EMPTY_FORM = {
  title: "", company: "", employment_type: "full_time", location: "",
...
export default function ExperienceAdmin() {
  ...
  const save = async () => {
    setSaving(true);
    try {
      const payload = { ...form, student_count: form.student_count ? Number(form.student_count) : null };
          ...
          <div key={item.id} className="ex-card">
            <div className="ex-body">
              ...
              <div className="ex-meta">
                <span className="ex-tag ex-tag-blue">{item.company}</span>
          ...
          <div className="ex-overlay" onClick={(e) => e.target === e.currentTarget && close()}>
            <div className="ex-modal">
              ...
              <div className="ex-modal-foot">
                ...
                <button className="ex-btn-save" onClick={save} disabled={saving || !form.title || !form.company}>
