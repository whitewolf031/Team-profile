...
const css = `
  ...
  .di-input, .di-textarea { background: #1a2235; border: 1px solid #1e2d45; color: #e2e8f0; padding: 10px 14px; border-radius: 8px; font-family: 'Syne', sans-serif; font-size: 0.9rem; transition: border-color 0.2s; width: 100%; }
  ...
  .di-upload input { position: absolute; inset: 0; opacity: 0; cursor: pointer; width: 100%; }
...
export default function DevInfoAdmin() {
  ...
  const [form, setForm] = useState({
    full_name: "", stack: "", experience: "", about: "", email: "", phone: "",
  });
  ...
  const open = (item = null) => {
    if (item) {
      setForm({ full_name: item.full_name || "", stack: item.stack || "", experience: item.experience || "", about: item.about || "", email: item.email || "", phone: item.phone || "" });
      setAvatarPreview(item.avatar || null);
      setEditing(item.id);
    } else {
      setForm({ full_name: "", stack: "", experience: "", about: "", email: "", phone: "" });
          ...
          <div key={item.id} className="di-card">
            ...
            <div className="di-body">
              ...
              <div className="di-meta">
                ...
                {item.experience && <span className="di-tag di-tag-green">{item.experience} yil tajriba</span>}
            ...
            <div className="di-actions">
              <button className="di-btn-icon" onClick={() => open(item)} title="Tahrirlash"><Icon name="edit" /></button>
              <button className="di-btn-icon danger" onClick={() => del(item.id)} title="O'chirish"><Icon name="trash" /></button>
            </div>
          </div>
        ))}
            ...
            <div className="di-modal">
              ...
              <div className="di-modal-body">
                ...
                <div className="di-field">
                  ...
                  <input className="di-input" placeholder="Sardorbek Ergashev" value={form.full_name}
                ...
                <div className="di-row">
                  <div className="di-field">
                    ...
                    <input className="di-input" placeholder="Python, Django, React" value={form.stack}
                      onChange={(e) => setForm({ ...form, stack: e.target.value })} />
                  </div>
                  <div className="di-field">
                    <label className="di-label">TAJRIBA (yil)</label>
                    <input className="di-input" type="number" placeholder="2" min="0" value={form.experience}
                ...
                <div className="di-field">
                  ...
                  <textarea className="di-textarea" placeholder="Men full-stack dasturchiman..." value={form.about}
                ...
                <div className="di-row">
                  <div className="di-field">
                    ...
                    <input className="di-input" type="email" placeholder="email@example.com" value={form.email}
                      onChange={(e) => setForm({ ...form, email: e.target.value })} />
                  </div>
                  <div className="di-field">
                    <label className="di-label">TELEFON</label>
                    <input className="di-input" placeholder="+998 90 123 45 67" value={form.phone}
