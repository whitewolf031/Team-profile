...
from .views import DevAdminInfoControl, DevAdminExperienceControl, DevAdminProjectControl, DevBlogControl, DevAdminSertificateControl
...
router.register(r'admin-control/sertificate', DevAdminSertificateControl, basename="admin-sertificate")
